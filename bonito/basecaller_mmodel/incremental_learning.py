...
from bonito.util import  load_symbol, init, half_supported
...
dirname = "/home/princezwang/software/bonito/bonito/models/dna_r9.4.1_e8_sup@v3.3"
...
scores = model(torch.randn(76,1,1))
print(seqs = model.decode_batch(scores))